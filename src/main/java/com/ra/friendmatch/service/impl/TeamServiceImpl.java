...
import com.ra.friendmatch.mapper.TeamMapper;
...
import com.ra.friendmatch.model.enums.TeamStatusEnum;
...
import com.ra.friendmatch.model.vo.UserVO;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("friendmatch:join_team");
        try {
            // 抢到锁并执行
            while (true) {
